...
import { getAntsPlatformTracer } from "./tracerProvider.js";
import {
...
import type {
  ...
  AntsPlatformEmbeddingAttributes,
...
/**
 * Union type representing any AntsPlatform observation wrapper.
 *
 * This type encompasses all observation types supported by AntsPlatform, providing
 ...
 *
 * ## Included Types
 * - **AntsPlatformSpan**: General-purpose operations and workflows
 * - **AntsPlatformGeneration**: LLM calls and AI model interactions
 * - **AntsPlatformEmbedding**: Text embedding and vector operations
 * - **AntsPlatformAgent**: AI agent workflows with tool usage
 * - **AntsPlatformTool**: Individual tool calls and API requests
 * - **AntsPlatformChain**: Multi-step processes and pipelines
 * - **AntsPlatformRetriever**: Document retrieval and search operations
 * - **AntsPlatformEvaluator**: Quality assessment and scoring
 * - **AntsPlatformGuardrail**: Safety checks and content filtering
 * - **AntsPlatformEvent**: Point-in-time occurrences and log entries
 *
 * @example
 * ```typescript
 * // Function accepting any observation type
 * function logObservation(obs: AntsPlatformObservation) {
 ...
 * @public
 */
export type AntsPlatformObservation =
  | AntsPlatformSpan
...
/**
 * Parameters for creating a AntsPlatform observation wrapper.
 *
 * @internal
 */
type AntsPlatformObservationParams = {
  otelSpan: Span;
...
/**
 * Base class for all AntsPlatform observation wrappers providing unified functionality.
 *
 * This abstract class serves as the foundation for all observation types in AntsPlatform,
 ...
 *
 * ## Core Capabilities
 * - **OpenTelemetry Integration**: Wraps OTEL spans with AntsPlatform-specific functionality
 ...
 * const observation: AntsPlatformObservation = startObservation('my-operation');
 *
 ...
 * @internal
 */
abstract class AntsPlatformBaseObservation {
  /** The underlying OpenTelemetry span */
  public readonly otelSpan: Span;
  /** The underlying OpenTelemetry span */
  public readonly type: AntsPlatformObservationType;
  /** The span ID from the OpenTelemetry span context */
  public id: string;
  /** The trace ID from the OpenTelemetry span context */
  public traceId: string;

  constructor(params: AntsPlatformObservationParams) {
  ...
  /** Gets the AntsPlatform OpenTelemetry tracer instance */
  protected get tracer() {
    return getAntsPlatformTracer();
  }
  ...
  updateOtelSpanAttributes(attributes: AntsPlatformObservationAttributes) {
    this.otelSpan.setAttributes(
   ...
   */
  public updateTrace(attributes: AntsPlatformTraceAttributes) {
   ...
   * }, { asType: 'generation' }); // Returns AntsPlatformGeneration
   *
   ...
   *     maxIterations: 5
   *   }
   * }, { asType: 'agent' }); // Returns AntsPlatformAgent
   *
   ...
   *     timeout: 10000
   *   }
   * }, { asType: 'tool' }); // Returns AntsPlatformTool
   *
   ...
   *     similarity: 'cosine'
   *   }
   * }, { asType: 'retriever' }); // Returns AntsPlatformRetriever
   *
   ...
   *   }
   * }, { asType: 'evaluator' }); // Returns AntsPlatformEvaluator
   *
   ...
   *     confidence: 0.95
   *   }
   * }, { asType: 'guardrail' }); // Returns AntsPlatformGuardrail
   *
   ...
   *   }
   * }, { asType: 'embedding' }); // Returns AntsPlatformEmbedding
   *
   ...
   *   }
   * }, { asType: 'event' }); // Returns AntsPlatformEvent (auto-ended)
   *
  ...
  public startObservation(
    name: string,
    attributes: AntsPlatformEventAttributes,
    options: { asType: "event" },
  ): AntsPlatformEvent;
  public startObservation(
    name: string,
    attributes: AntsPlatformAgentAttributes,
    options: { asType: "agent" },
  ): AntsPlatformAgent;
  public startObservation(
    name: string,
    attributes: AntsPlatformToolAttributes,
    options: { asType: "tool" },
  ): AntsPlatformTool;
  public startObservation(
    name: string,
    attributes: AntsPlatformChainAttributes,
    options: { asType: "chain" },
  ): AntsPlatformChain;
  public startObservation(
    name: string,
    attributes: AntsPlatformRetrieverAttributes,
    options: { asType: "retriever" },
  ): AntsPlatformRetriever;
  public startObservation(
    name: string,
    attributes: AntsPlatformEvaluatorAttributes,
    options: { asType: "evaluator" },
  ): AntsPlatformEvaluator;
  public startObservation(
    name: string,
    attributes: AntsPlatformGuardrailAttributes,
    options: { asType: "guardrail" },
  ): AntsPlatformGuardrail;
  public startObservation(
    name: string,
    attributes: AntsPlatformEmbeddingAttributes,
  ...
  public startObservation(
    ...
    attributes?:
      ...
      | AntsPlatformGuardrailAttributes
      | AntsPlatformEmbeddingAttributes,
    options?: { asType?: AntsPlatformObservationType },
  ): AntsPlatformObservation {
 ...
 *
 * AntsPlatformSpan is the default and most versatile observation type, designed for tracing
 ...
 * @see {@link AntsPlatformGeneration} - For LLM and AI model interactions
 * @see {@link AntsPlatformEvent} - For point-in-time occurrences
 *
 * @public
 */
export class AntsPlatformSpan extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformSpanParams) {
   ...
   * ```
   */
  public update(attributes: AntsPlatformSpanAttributes): AntsPlatformSpan {
 ...
 *
 * AntsPlatformAgent is designed for observing intelligent agent systems that combine reasoning,
 ...
 * @see {@link AntsPlatformTool} - For individual tool executions within agents
 * @see {@link AntsPlatformChain} - For structured multi-step workflows
 *
 * @public
 */
export class AntsPlatformAgent extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformAgentParams) {
   ...
   * ```
   */
  public update(attributes: AntsPlatformAgentAttributes): AntsPlatformAgent {
    super.updateOtelSpanAttributes(attributes);
 ...
 *
 * AntsPlatformTool is designed for observing discrete tool invocations within agent workflows,
 ...
 * @see {@link AntsPlatformAgent} - For agent workflows that use multiple tools
 * @see {@link AntsPlatformChain} - For orchestrated tool sequences
 *
 * @public
 */
export class AntsPlatformTool extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformToolParams) {
   ...
   * ```
   */
  public update(attributes: AntsPlatformToolAttributes): AntsPlatformTool {
    super.updateOtelSpanAttributes(attributes);
 ...
 *
 * AntsPlatformChain is designed for observing sequential, parallel, or conditional workflow orchestration
 ...
 * @see {@link AntsPlatformSpan} - For individual workflow steps
 * @see {@link AntsPlatformAgent} - For intelligent workflow orchestration
 *
 * @public
 */
export class AntsPlatformChain extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformChainParams) {
   ...
   * ```
   */
  public update(attributes: AntsPlatformChainAttributes): AntsPlatformChain {
    super.updateOtelSpanAttributes(attributes);
...
type AntsPlatformRetrieverParams = {
  otelSpan: Span;
  attributes?: AntsPlatformRetrieverAttributes;
};
 ...
 *
 * AntsPlatformRetriever is designed for observing information retrieval systems that search,
 ...
 * @see {@link AntsPlatformChain} - For multi-step RAG pipelines
 * @see {@link AntsPlatformEmbedding} - For embedding generation used in vector search
 *
 * @public
 */
export class AntsPlatformRetriever extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformRetrieverParams) {
...
type AntsPlatformEvaluatorParams = {
  otelSpan: Span;
  attributes?: AntsPlatformEvaluatorAttributes;
};
 ...
 *
 * AntsPlatformEvaluator is designed for observing evaluation systems that assess, score, and
 ...
 * @see {@link AntsPlatformGeneration} - For LLM outputs being evaluated
 * @see {@link AntsPlatformGuardrail} - For safety and compliance enforcement
 *
 * @public
 */
export class AntsPlatformEvaluator extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformEvaluatorParams) {
...
type AntsPlatformGuardrailParams = {
  otelSpan: Span;
  attributes?: AntsPlatformGuardrailAttributes;
};
 ...
 *
 * AntsPlatformGuardrail is designed for observing safety and compliance systems that prevent,
 ...
 * @see {@link AntsPlatformEvaluator} - For detailed quality and safety assessment
 * @see {@link AntsPlatformGeneration} - For protecting LLM outputs with guardrails
 *
 * @public
 */
export class AntsPlatformGuardrail extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformGuardrailParams) {
...
/**
 * Parameters for creating a AntsPlatform generation.
 *
 * @internal
 */
type AntsPlatformGenerationParams = {
  otelSpan: Span;
  attributes?: AntsPlatformGenerationAttributes;
};
 ...
 *
 * AntsPlatformGeneration is purpose-built for observing AI model interactions, providing rich
 ...
 * @see {@link AntsPlatformSpan} - For general-purpose operations
 * @see {@link AntsPlatformEmbedding} - For text embedding and vector operations
 *
 * @public
 */
export class AntsPlatformGeneration extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformGenerationParams) {
    super({ ...params, type: "generation" });
  }

  update(attributes: AntsPlatformGenerationAttributes): AntsPlatformGeneration {
...
type AntsPlatformEmbeddingParams = {
  otelSpan: Span;
  attributes?: AntsPlatformEmbeddingAttributes;
};
 ...
 *
 * AntsPlatformEmbedding is designed for observing embedding model interactions that convert
 ...
 * @see {@link AntsPlatformRetriever} - For using embeddings in vector search
 * @see {@link AntsPlatformGeneration} - For LLM operations that may use embeddings
 *
 * @public
 */
export class AntsPlatformEmbedding extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformEmbeddingParams) {
   ...
   */
  update(attributes: AntsPlatformEmbeddingAttributes): AntsPlatformEmbedding {
    this.updateOtelSpanAttributes(attributes);
...
/**
 * Parameters for creating a AntsPlatform event.
 *
 * @internal
 */
type AntsPlatformEventParams = {
  otelSpan: Span;
  attributes?: AntsPlatformEventAttributes;
  timestamp: TimeInput;
};
...
/**
 * AntsPlatform event wrapper for point-in-time observations.
 *
 ...
 * @public
 */
export class AntsPlatformEvent extends AntsPlatformBaseObservation {
  constructor(params: AntsPlatformEventParams) {
