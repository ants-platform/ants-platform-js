![GitHub Banner](https://github.com/ants-platform/ants-platform-js/assets/banner.png)

# @antsplatform/tracing

This is the tracing package of the Ants Platform JS SDK containing the instrumentation methods for instrumenting your LLM app such as `startActiveSpan`, `startActiveGeneration`, and the `observe` wrapper.
