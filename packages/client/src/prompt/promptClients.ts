...
export class TextPromptClient extends BasePromptClient {
   ...
   * @example
   * ```typescript
   * const prompt = await antsPlatform.prompt.get("greeting", { type: "text" });
...
export class ChatPromptClient extends BasePromptClient {
   ...
   * @example
   * ```typescript
   * const prompt = await antsPlatform.prompt.get("conversation", { type: "chat" });
 ...
 * @public
 */
export type AntsPlatformPromptClient = TextPromptClient | ChatPromptClient;
