...
export declare namespace AntsPlatformAPIClient {
...
export class AntsPlatformAPIClient {
  protected readonly _options: AntsPlatformAPIClient.Options;
  ...
  constructor(_options: AntsPlatformAPIClient.Options) {
    this._options = {
      ..._options,
      headers: mergeHeaders(
        {
          "X-Ants-Platform-Sdk-Name": _options?.xAntsPlatformSdkName,
          "X-Ants-Platform-Sdk-Version": _options?.xAntsPlatformSdkVersion,
          "X-Ants-Platform-Public-Key": _options?.xAntsPlatformPublicKey,
        },
        _options?.headers,
      ),
    };
