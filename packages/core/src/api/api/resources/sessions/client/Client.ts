...
export class Sessions {
   ...
   * Get sessions
   *
   * @param {AntsPlatformAPI.GetSessionsRequest} request
   ...
   */
  public list(
    request: AntsPlatformAPI.GetSessionsRequest = {},
    requestOptions?: Sessions.RequestOptions,
  ): core.HttpResponsePromise<AntsPlatformAPI.PaginatedSessions> {
  ...
  private async __list(
    request: AntsPlatformAPI.GetSessionsRequest = {},
    requestOptions?: Sessions.RequestOptions,
  ): Promise<core.WithRawResponse<AntsPlatformAPI.PaginatedSessions>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as AntsPlatformAPI.PaginatedSessions,
  ...
  public get(
    sessionId: string,
    requestOptions?: Sessions.RequestOptions,
  ): core.HttpResponsePromise<AntsPlatformAPI.SessionWithTraces> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __get(
    sessionId: string,
    requestOptions?: Sessions.RequestOptions,
  ): Promise<core.WithRawResponse<AntsPlatformAPI.SessionWithTraces>> {
    const _response = await core.fetcher({
      url: core.url.join(
        (await core.Supplier.get(this._options.baseUrl)) ??
          (await core.Supplier.get(this._options.environment)),
    ...
    if (_response.ok) {
      return {
        data: _response.body as AntsPlatformAPI.SessionWithTraces,
        rawResponse: _response.rawResponse,
      };
    }
