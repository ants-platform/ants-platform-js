...
export class Health {
   ...
   *
   * @throws {@link AntsPlatformAPI.ServiceUnavailableError}
  ...
  ): core.HttpResponsePromise<AntsPlatformAPI.HealthResponse> {
    return core.HttpResponsePromise.fromPromise(this.__health(requestOptions));
  }

  private async __health(
    requestOptions?: Health.RequestOptions,
  ): Promise<core.WithRawResponse<AntsPlatformAPI.HealthResponse>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as AntsPlatformAPI.HealthResponse,
    ...
    if (_response.error.reason === "status-code") {
      switch (_response.error.statusCode) {
        case 503:
          throw new AntsPlatformAPI.ServiceUnavailableError(
