...
export interface CreateScoreConfigRequest {
  ...
  categories?: AntsPlatformAPI.ConfigCategory[];
  ...
  maxValue?: number;
  /** Description is shown across the AntsPlatform UI and can be used to e.g. explain the config categories in detail, why a numeric range was set, or provide additional context on config name or usage */
  description?: string;
}
