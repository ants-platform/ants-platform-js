...
export class Metrics {
  ...
  /**
   * Get metrics from the AntsPlatform project using a query object
   *
   * @param {AntsPlatformAPI.GetMetricsRequest} request
   ...
   */
  public metrics(
    request: AntsPlatformAPI.GetMetricsRequest,
    requestOptions?: Metrics.RequestOptions,
  ): core.HttpResponsePromise<AntsPlatformAPI.MetricsResponse> {
  ...
  private async __metrics(
    request: AntsPlatformAPI.GetMetricsRequest,
    requestOptions?: Metrics.RequestOptions,
  ): Promise<core.WithRawResponse<AntsPlatformAPI.MetricsResponse>> {
    const { query } = request;
    ...
    if (_response.ok) {
      return {
        data: _response.body as AntsPlatformAPI.MetricsResponse,
