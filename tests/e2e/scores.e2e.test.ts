...
import { resetGlobalLogger } from "@ants-platform/core";
...
function createAntsPlatformClient(): AntsPlatformClient {
  return new AntsPlatformClient();
}

describe("AntsPlatformClient Score E2E Tests", () => {
  ...
  describe("Score Creation Flow Validation", () => {
    it("should successfully create and flush scores without errors", async () => {
      const client = createAntsPlatformClient();
