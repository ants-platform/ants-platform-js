...
describe("Tracing Methods Interoperability E2E Tests", () => {
  ...
  describe("startObservation method", () => {
    ...
    it("should create span with custom attributes", async () => {
      ...
      assertions.expectSpanAttribute(
        "test-span",
        AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".key",
        "value",
      );
      assertions.expectSpanAttribute(
        "test-span",
    ...
    it("should handle span with error status", async () => {
      ...
      assertions.expectSpanAttribute(
        "error-span",
        AntsPlatformOtelSpanAttributes.OBSERVATION_LEVEL,
        "ERROR",
      );
      assertions.expectSpanAttribute(
        "error-span",
        AntsPlatformOtelSpanAttributes.OBSERVATION_STATUS_MESSAGE,
        "Test error",
      );
    });
    ...
    describe("Nested spans", () => {
      it("should create nested spans with correct parent-child relationships", async () => {
        ...
        assertions.expectSpanAttribute(
          "parent-span",
          AntsPlatformOtelSpanAttributes.TRACE_NAME,
          "nested-spans-trace",
        );
        ...
        expect(parentAttributes).toHaveProperty("antsPlatform.trace.tags");
        expect(parentAttributes["antsPlatform.trace.tags"]).toEqual(
      ...
      it("should handle multiple child spans", async () => {
        ...
        assertions.expectSpanAttributeContains(
          "parent-span",
          AntsPlatformOtelSpanAttributes.TRACE_METADATA + ".test_type",
          "multi-child",
        );
        assertions.expectSpanAttributeContains(
          "parent-span",
          AntsPlatformOtelSpanAttributes.TRACE_METADATA + ".version",
          "1.0",
        );
      });
    });
    ...
    describe("Environment and release attributes", () => {
      it("should add environment and release attributes from span processor", async () => {
        ...
        assertions.expectSpanAttribute(
          "env-span",
          AntsPlatformOtelSpanAttributes.ENVIRONMENT,
          "test-env",
        );
        assertions.expectSpanAttribute(
          "env-span",
          AntsPlatformOtelSpanAttributes.RELEASE,
          "v1.0.0",
        );
      });
    });
  ...
  describe("startObservation with generation type", () => {
    it("should create generation with proper observation type", async () => {
      ...
      assertions.expectSpanAttribute(
        "test-generation",
        AntsPlatformOtelSpanAttributes.OBSERVATION_MODEL,
        "gpt-4",
      );
      assertions.expectSpanAttribute(
        "test-generation",
      ...
      assertions.expectSpanAttribute(
        "test-generation",
        AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".test_run",
        "true",
      );
      assertions.expectSpanAttribute(
        "test-generation",
        AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".version",
        "1.0",
      );
      ...
      assertions.expectSpanAttribute(
        "test-generation",
        AntsPlatformOtelSpanAttributes.TRACE_PUBLIC,
        true,
      );
    });
  ...
  describe("startObservation with event type", () => {
    it("should create event with proper observation type", async () => {
      ...
      assertions.expectSpanAttribute(
        "test-event",
        AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".element",
        "button",
      );
      assertions.expectSpanAttributeContains(
        "test-event",
        "antsPlatform.observation.metadata.coordinates",
        "100",
      );
      ...
      expect(eventParentAttrs).toHaveProperty("antsPlatform.trace.tags");
      expect(eventParentAttrs["antsPlatform.trace.tags"]).toEqual(
        expect.arrayContaining(["events"]),
      );
      assertions.expectSpanAttribute(
        "event-parent",
        AntsPlatformOtelSpanAttributes.TRACE_METADATA + ".platform",
        "web",
      );
    });
    ...
    it("should create event with custom timestamp", async () => {
      ...
      assertions.expectSpanAttribute(
        "timestamped-event",
        AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".source",
        "test-suite",
      );
      assertions.expectSpanAttributeContains(
        "timestamped-event",
  ...
  describe("startObservation with agent type", () => {
    ...
    it("should allow updating agent attributes", async () => {
      ...
      assertions.expectSpanAttribute(
        "agent-with-updates",
        AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".processingTime",
        "150",
      );
    });
  });
  ...
  describe("startActiveObservation method", () => {
    it("should execute function with active span context", async () => {
      ...
      expect(spanAttributes).toHaveProperty(
        "antsPlatform.observation.metadata.execution_time",
      );
      expect(
      ...
      assertions.expectSpanAttribute(
        "active-span",
        AntsPlatformOtelSpanAttributes.TRACE_METADATA + ".execution_context",
        "active",
      );
  ...
  describe("startActiveObservation with generation type", () => {
    ...
    describe("Promise handling for generations", () => {
      it("should handle LLM generation promise resolution", async () => {
        ...
        assertions.expectSpanAttribute(
          "async-llm-generation",
          AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".temperature",
          "0.7",
        );
        assertions.expectSpanAttribute(
          "async-llm-generation",
          AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".max_tokens",
          "100",
        );
        ...
        expect(llmGenAttrs).toHaveProperty("antsPlatform.trace.tags");
        expect(llmGenAttrs["antsPlatform.trace.tags"]).toEqual(
  ...
  describe("Method interoperability", () => {
    it("should create complex trace with all observation types", async () => {
      ...
      expect(workflowAttributes).toHaveProperty("antsPlatform.trace.tags");
      expect(workflowAttributes["antsPlatform.trace.tags"]).toEqual(
  ...
  describe("Active span/generation/trace update methods", () => {
    ...
    describe("updateActiveGeneration", () => {
      ...
      it("should update generation during observe function with asType generation", async () => {
        ...
        assertions.expectSpanAttribute(
          "llmFunc",
          AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".provider",
          "openai",
        );
      });
    });
    ...
    describe("updateActiveTrace", () => {
      it("should update active trace attributes when called within startActiveObservation", async () => {
        ...
        assertions.expectSpanAttribute(
          "test-span",
          AntsPlatformOtelSpanAttributes.TRACE_USER_ID,
          "user-123",
        );
        assertions.expectSpanAttribute(
          "test-span",
          AntsPlatformOtelSpanAttributes.TRACE_SESSION_ID,
          "session-456",
        );
        assertions.expectSpanAttribute(
          "test-span",
        ...
        assertions.expectSpanAttribute(
          "test-span",
          AntsPlatformOtelSpanAttributes.TRACE_METADATA + ".environment",
          "test",
        );
        // Check tags array using toStrictEqual
        expect(
          assertions.mockExporter.getSpanByName("test-span")!.attributes[
            AntsPlatformOtelSpanAttributes.TRACE_TAGS
          ],
      ...
      it("should update trace during nested span operations", async () => {
        ...
        assertions.expectSpanAttribute(
          "child-span",
          AntsPlatformOtelSpanAttributes.TRACE_METADATA + ".childOperation",
          "processing",
        );
      });
      ...
      it("should update trace during observe function execution", async () => {
        ...
        assertions.expectSpanAttribute(
          "testFunc",
          AntsPlatformOtelSpanAttributes.TRACE_METADATA + ".source",
          "observe-function",
        );
      });
    });
    ...
    describe("Combined update methods", () => {
      it("should handle multiple update methods called together", async () => {
        ...
        assertions.expectSpanAttribute(
          "combined-span",
          AntsPlatformOtelSpanAttributes.OBSERVATION_METADATA + ".step",
          "1",
        );
      });
